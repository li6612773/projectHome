...
public class D01_EXC_Throw {
    ...
    //异常的传播
         ...
         */
        //printStackTrace()对于调试错误非常有用，上述信息表示：NumberFormatException是
        // 在java.lang.Integer.parseInt方法中被抛出的，从下往上看，调用层次依次是：
        //
        //main()调用process1()；
        //process1()调用process2()；
    ...
    //抛出异常
        ...
        //当process2()抛出NullPointerException后，被process1()捕获，
        // 然后抛出IllegalArgumentException()。
        //
    ...
    //提问时贴出异常
        //异常打印的详细的栈信息是找出问题的关键，许多初学者在提问时只贴代码，不贴异常，相当于只报案不给线索，
        // 福尔摩斯也无能为力。
        //
        //谁教你提问不贴异常栈
        //
