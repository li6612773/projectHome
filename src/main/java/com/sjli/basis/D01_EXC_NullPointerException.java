...
public class D01_EXC_NullPointerException {
    public static void main(String[] args) {
        //
        //在所有的RuntimeException异常中，Java程序员最熟悉的恐怕就是NullPointerException了。
        //
        //NullPointerException即空指针异常，俗称NPE。如果一个对象为null，
    ...
    //处理NullPointerException
        ...
        // NullPointerException是一种代码逻辑错误，遇到NullPointerException，
    ...
    //定位NullPointerException
        //如果产生了NullPointerException，例如，调用a.b.c.x()时产生了NullPointerException，
        // 原因可能是：
        //
        //a是null；
        //a.b是null；
        ...
        // "<local1>.address.city" is null，意思是city字段为null，这样我们就能快速定位问题所在。
        //
